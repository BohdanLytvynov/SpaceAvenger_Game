    ...
    internal class UserProfileInfo_ViewModel : SubscriptableViewModel, IDisposable
    {
        ...
        { 
            ...
            set 
            {
                ...
                {
                    UserImage = LoadImageUsingUri("pack://siteoforigin:,,,/WPFResources/Images/Chars/Commanders/CommandersM.png", UriKind.RelativeOrAbsolute);
                }
                else
                {
                    UserImage = LoadImageUsingUri("pack://siteoforigin:,,,/WPFResources/Images/Chars/Commanders/CommandersF.png", UriKind.RelativeOrAbsolute);
                }
            } 
        }
